...
<div class="wrapper">
 ...
 <?php include("main-folder/navbar.php");?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <button type="button" name="add" class="btn btn-info btn-sm" data-toggle="modal" data-target="#insert_drugs_modal"><i class="fa fa-dollar"></i> Add drugs</button>
        ...
        <div class="card-body">
                ...
                echo "<h1 class='btn btn-success '>UPdated success</h1>";
                 ...
                 ?>
                  <?php
              if (isset($_POST['btn_insert_drugs'])){
                $drug_id = mysqli_real_escape_string($conn, $_POST['drug_id']);
                $drug_name = mysqli_real_escape_string($conn, $_POST['drug_name']);            
                $issu_date = mysqli_real_escape_string($conn, $_POST['issu_date']);            
                $expire_date = mysqli_real_escape_string($conn, $_POST['expire_date']);            
                ...
                $reg_date= mysqli_real_escape_string($conn, $_POST['reg_date']);
                $userid= mysqli_real_escape_string($conn, $_POST['userid']);
                $insert = mysqli_query($conn, "INSERT INTO drugs VALUES(null, '$drug_id', '$drug_name','$issu_date','$expire_date','$price','$description','$reg_date','$userid')");
              ...
              ?>
                    ...
                    if(isset($_GET['idd'])){
                    $id =$_GET['idd'];
                    $tir = mysqli_query($conn,"delete from drugs where drug_id= $id");
        ...
        <td>
            <a href="drugs_edit.php? idd=<?php echo $row[0];?>" class="btn btn-success btn-sm"onclick= "return confirm('ma wxaa rabtaa inaa update gareyneyso xogtaan')"><i class="fa fa-edit"></i></a>
            <a href="drugs.php? idd=<?php echo $row[0];?>" class="btn btn-danger btn-sm" onclick= "return confirm('ma hubtaa inaad delete gareyneyso xogtaan')"><i class="fa fa-trash"></i></a>
  ...
  <!-- /.content-wrapper -->
<?php include("modal/insert_drugs.php");?>
