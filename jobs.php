...
<div class="wrapper">
 ...
 <?php include("main-folder/navbar.php");?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <button type="button" name="add" class="btn btn-info btn-sm" data-toggle="modal" data-target="#insert_jobs_modal"><i class="fa fa-dollar"></i> Add jobs</button>
        ...
        <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 ?>
                  <?php
              if (isset($_POST['btn_insert_jobs'])){
               
                    $job_id = mysqli_real_escape_string($conn, $_POST['job_id']);
                    $job_name = mysqli_real_escape_string($conn, $_POST['job_name']);            
                    $reg_date= mysqli_real_escape_string($conn, $_POST['reg_date']);
                    $userid= mysqli_real_escape_string($conn, $_POST['userid']);
                    $insert = mysqli_query($conn, "INSERT INTO  jobs  VALUES(null, '$job_id', '$job_name','$reg_date','$userid')");
              ...
              ?>
                    ...
                    if(isset($_GET['idd'])){
                    $id =$_GET['idd'];
                    $tir = mysqli_query($conn,"delete from jobs where job_id= $id");
        ...
        <td>
            <a href="jobs_edit.php? idd=<?php echo $row[0];?>" class="btn btn-success btn-sm"onclick= "return confirm('ma wxaa rabtaa inaa update gareyneyso xogtaan')"><i class="fa fa-edit"></i></a>
            <a href="jobs.php? idd=<?php echo $row[0];?>" class="btn btn-danger btn-sm" onclick= "return confirm('ma hubtaa inaad delete gareyneyso xogtaan')"><i class="fa fa-trash"></i></a>
  ...
  <!-- /.content-wrapper -->
<?php include("modal/insert_jobs.php");?>
